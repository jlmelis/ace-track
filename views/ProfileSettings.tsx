  ...
  return (
    <div className="animate-in slide-in-from-right-4 duration-200 pb-24">
      ...
      <div className="bg-white p-4 border-b flex items-center justify-between sticky sub-header-top z-40 shadow-sm">
        ...
        <button 
          onClick={handleSave}
          className="flex items-center gap-1.5 bg-indigo-600 text-white px-4 py-2 rounded-lg font-bold text-sm active:scale-95 transition-all shadow-md shadow-indigo-100"
        >
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-slate-600">
                <Database size={16} />
                <span className="text-xs font-bold uppercase">Device Storage</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button 
                ...
                className="flex items-center justify-center gap-2 bg-white border border-slate-200 py-3 rounded-xl font-bold text-xs text-slate-700 active:bg-slate-100 shadow-sm"
              >
            ...
            <div className="p-3 bg-white rounded-lg border border-slate-200">
               <div className="flex gap-2 text-amber-600 mb-1">
                 ...
                 <span className="text-[10px] font-bold uppercase">Privacy First</span>
               </div>
               <p className="text-[10px] text-slate-500 leading-relaxed font-medium">
                No data is sent to a server. This app uses "Local-Only" storage. To move data to a new phone, use the Backup/Restore buttons above.
               </p>
            </div>

            <button 
              onClick={clearData}
              className="w-full flex items-center justify-center gap-2 text-red-600 font-bold text-xs py-3 bg-red-50 border border-red-100 rounded-lg active:bg-red-100 transition-colors"
            >
              <Trash2 size={16} />
              Reset Application
            </button>
