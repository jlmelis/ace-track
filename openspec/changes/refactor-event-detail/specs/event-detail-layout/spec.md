...
Define the structural layout and component hierarchy of the Event Detail view, ensuring users have immediate access to their primary actions (matches) while retaining available top-level analytics (tournament stats).
