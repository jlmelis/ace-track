...
Define service worker registration behavior for the AceTrack PWA, ensuring optimal development experience with Vite HMR while maintaining production caching and update functionality.
